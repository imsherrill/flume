...
export declare type RichElementMap = {
    [commentId: string]: ReactNode;
};
...
export declare type NodeHeaderRenderCallback = (Wrapper: React.FC<HTMLProps<HTMLHeadingElement>>, nodeType: NodeType, actions: NodeHeaderActions, meta: {
    nodeId: string;
}) => ReactNode;
