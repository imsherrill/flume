...
var ContextMenu = function ContextMenu(_ref) {
  ...
  var menuWrapper = React__default["default"].useRef(null);
  var menuOptionsWrapper = React__default["default"].useRef(null);
  var filterInput = React__default["default"].useRef(null);
...
var NodeTypesContext = /*#__PURE__*/React__default["default"].createContext(null);
var PortTypesContext = /*#__PURE__*/React__default["default"].createContext(null);
var NodeDispatchContext = /*#__PURE__*/React__default["default"].createContext(null);
var ConnectionRecalculateContext = /*#__PURE__*/React__default["default"].createContext(null);
var ContextContext = /*#__PURE__*/React__default["default"].createContext(null);
var StageContext = /*#__PURE__*/React__default["default"].createContext(null);
var CacheContext = /*#__PURE__*/React__default["default"].createContext(null);
var RecalculateStageRectContext = /*#__PURE__*/React__default["default"].createContext(null);
...
(function (NodesActionType) {
  ...
  NodesActionType["HARD_SET_NODES"] = "HARD_SET_NODES";
...
var Stage = function Stage(_ref) {
  ...
  var wrapper = React__default["default"].useRef(null);
  var translateWrapper = React__default["default"].useRef(null);
...
function TextInput(_ref) {
  ...
  if (type === "number") {
    return /*#__PURE__*/React__default["default"].createElement(core.NumberInput, _objectSpread$9(_objectSpread$9({}, commonProps), {}, {
      value: data,
  ...
  return /*#__PURE__*/React__default["default"].createElement(core.Textarea, _objectSpread$9(_objectSpread$9({}, commonProps), {}, {
    value: data,
    onChange: function onChange(e) {
...
var Select = function Select(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, allowMultiple && typeof data !== "string" ? data.length ? /*#__PURE__*/React__default["default"].createElement("div", {
...
var Control = function Control(props) {
  ...
  var getControlByType = function getControlByType(type) {
    ...
    switch (type) {
      case "select":
        {
          ...
          return /*#__PURE__*/React__default["default"].createElement(Select, _objectSpread$7(_objectSpread$7({}, commonProps), {}, {
      ...
      case "text":
        {
          ...
          return /*#__PURE__*/React__default["default"].createElement(TextInput, _objectSpread$7(_objectSpread$7({}, commonProps), {}, {
      ...
      case "checkbox":
        return /*#__PURE__*/React__default["default"].createElement(Checkbox, _objectSpread$7(_objectSpread$7({}, commonProps), {}, {
      ...
      case "multiselect":
        {
          ...
          return /*#__PURE__*/React__default["default"].createElement(Select, _objectSpread$7(_objectSpread$7({
            allowMultiple: true
          }, commonProps), {}, {
...
var IoPorts = function IoPorts(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Input, _objectSpread$6(_objectSpread$6({}, input), {}, {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Output, _objectSpread$6(_objectSpread$6({}, output), {}, {
      triggerRecalculation: triggerRecalculation,
...
var Input = function Input(_ref3) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Control, _objectSpread$6(_objectSpread$6({}, control), {}, {
      nodeId: nodeId,
      portName: name,
      triggerRecalculation: triggerRecalculation,
      updateNodeConnections: updateNodeConnections,
...
var Port = function Port(_ref7) {
  ...
  var port = React__default["default"].useRef(null);
  var line = React__default["default"].useRef(null);
  var lineInToPort = React__default["default"].useRef(null);
  ...
  }, /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Connection, {
...
var Node = function Node(_ref) {
  ...
  var id = _ref.id,
      ...
      appendage = _ref.appendage;
  var cache = (_React$useContext = React__default["default"].useContext(CacheContext)) !== null && _React$useContext !== void 0 ? _React$useContext : undefined;
  var nodeTypes = (_React$useContext2 = React__default["default"].useContext(NodeTypesContext)) !== null && _React$useContext2 !== void 0 ? _React$useContext2 : {};
  var nodesDispatch = React__default["default"].useContext(NodeDispatchContext);
  var stageState = (_React$useContext3 = React__default["default"].useContext(StageContext)) !== null && _React$useContext3 !== void 0 ? _React$useContext3 : {
    scale: 0,
    translate: {
      x: 0,
      y: 0
  ...
  var nodeWrapper = React__default["default"].useRef(null);
  ...
  return /*#__PURE__*/React__default["default"].createElement(Draggable, {
    ...
    nodeId: id
  }) : /*#__PURE__*/React__default["default"].createElement(NodeHeader, null, label), /*#__PURE__*/React__default["default"].createElement(IoPorts, {
    nodeId: id,
    inputs: inputs,
    outputs: outputs,
...
var NodeHeader = function NodeHeader(_ref6) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("h2", _objectSpread$5(_objectSpread$5({}, props), {}, {
...
var Comment = (function (_ref) {
  ...
  var stageState = React__default["default"].useContext(StageContext);
  var wrapper = React__default["default"].useRef(null);
  var textarea = React__default["default"].useRef(null);
  ...
  var handleRequestClose = React__default["default"].useCallback(function () {
...
var Toaster = function Toaster(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Toast, _objectSpread$3(_objectSpread$3({}, toast), {}, {
...
var defaultContext = {};
var NodeEditor = /*#__PURE__*/React__default["default"].forwardRef(function (_ref, ref) {
  var _useId;

  var initialComments = _ref.comments,
      appendages = _ref.appendages,
      ...
      _ref$initialPan = _ref.initialPan,
      initialPan = _ref$initialPan === void 0 ? {
    x: 0,
    y: 0
  } : _ref$initialPan,
  ...
  var cache = React__default["default"].useRef(new FlumeCache());
  ...
  var _React$useReducer3 = React__default["default"].useReducer(connectNodesReducer(nodesReducer, {
    nodeTypes: nodeTypes,
    portTypes: portTypes,
    cache: cache,
  ...
  var recalculateStageRect = React__default["default"].useCallback(function () {
  ...
  var triggerRecalculation = React__default["default"].useCallback(function () {
    setShouldRecalculateConnections(true);
  }, []);
    ...
    return {
      ...
      setNodes: function setNodes(newNodes) {
        dispatchNodes({
          ...
          nodes: getInitialNodes(newNodes, defaultNodes, nodeTypes, portTypes, context)
        });
      },
  ...
  return /*#__PURE__*/React__default["default"].createElement(PortTypesContext.Provider, {
    ...
    return /*#__PURE__*/React__default["default"].createElement(Comment, _objectSpread$2(_objectSpread$2({}, comment), {}, {
      stageRect: stage,
    ...
    return /*#__PURE__*/React__default["default"].createElement(Node, _objectSpread$2(_objectSpread$2({}, node), {}, {
      stageRect: stage,
      onDragStart: recalculateStageRect,
      renderNodeHeader: renderNodeHeader,
      key: node.id,
      appendage: appendages === null || appendages === void 0 ? void 0 : appendages[node.id]
    }));
