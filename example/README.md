...
The easiest way to get started is to open two terminals, one to the root, and one to the /example directory. In the root run `yarn start`, and then in the example run `yarn start`.
